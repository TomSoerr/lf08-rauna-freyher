  ...
  document.body.append(
    ...
    main(
      ...
      section([
        ...
        ...p('Mich haben die vielen leeren Plastikflaschen von Duschgels und Shampoos genervt. Und ich habe mir gedacht, das muss doch auch umweltfreundlicher funktionieren. So sind zunächst mein Shampoo und die Handseifen entstanden.'),
        ...
        ...p('Die Tiegel aus Kunststoff nehme ich ebenfalls gerne zurück und nutze sie nach Reinigung mehrfach. Nachhaltigkeit, Natürlichkeit und Naturverbundenheit sind für meine Produkte und mich wichtige Schlagwörter. So komme ich in der Herstellung ohne Zusätze von Erdöl, synthetischen Konservierungsmitteln, Mikroplastik und Tierversuchen aus.'),
        ...
        ...p('Mir ist es wichtig, meine Kunden zufriedenzustellen; so kann man mir immer gerne ins Gespräch gehen, wenn bestimmte Hauptprobleme, Unverträglichkeiten oder Ähnliches vorliegen und wir entwickeln gemeinsam eine passende Lösung.'),
