...
function load() {
  document.body.append(
    ...
    main(
      ...
      sectionImgText({
        heading: 'Warum Naturkosmetik?',
        text: 'Die Verwendung von Naturkosmetik bietet zahlreiche Vorteile, die sowohl für die Haut als auch für die Umwelt relevant sind. Im Gegensatz zu herkömmlichen Kosmetikprodukten, die oft synthetische Inhaltsstoffe, Parabene und künstliche Duftstoffe enthalten, setzt Naturkosmetik auf natürliche und biologisch abbaubare Substanzen. Naturkosmetik verzichtet auf aggressive Chemikalien, die Hautreizungen und allergische Reaktionen auslösen können, und enthalten natürliche Inhaltsstoffe wie Pflanzenextrakte, ätherische Öle und Kräuter.',
        reverse: false,
        background: 'default',
      }),
      sectionImgText({
        heading: 'Bienenprodukte in Naturkosmetik',
        text: 'Bienenprodukte wie Honig, Propolis, Gelee Royal und Bienenwachs entfalten ihre Vorteile für Haut und Haare. Honig als Feuchtigkeitsspender, Propolis mit antibakteriellen Eigenschaften, Gelee Royal zur Förderung der Zellerneuerung und Bienenwachs als schützende Barriere sind äußerst vorteilhaft für die Schönheitspflege.',
        reverse: true,
        background: 'secondary',
      }),
      sectionImgText({
        heading: 'Duftstoffe in Naturkosmetik',
        text: 'Blütenwasser und ätherische Öle sind wesentliche Bestandteile der Naturkosmetik. Sie bieten hautfreundliche Eigenschaften, beleben, beruhigen und hydratisieren die Haut. Ätherische Öle wie Lavendelöl und Teebaumöl pflegen die Haut mit ihren feuchtigkeitsspendenden, beruhigenden oder antibakteriellen Kräften.',
        reverse: false,
      ...
      sectionImgText({
        heading: 'Hier kommt die Überschrift hin',
        text: 'Hier kommt der Text hin',
        reverse: true || false,
        background: 'secondary' || 'secondary-2',
      }),
    ),
    footer(),
  );
